...
def pear_shell_out(command)
  # shell_out always times out after 10 minutes which may not be long enough for big packages on slow connection
  # This should in future be configurable
  p = shell_out!(command, {:timeout => 3600})
